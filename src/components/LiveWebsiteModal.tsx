        ...
        <header className="bg-[#071A2B] text-white border-b border-[#0f2c45]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-[#0f2c45] border border-[#7FFFD4]/40 flex items-center justify-center text-[#7FFFD4]">
                <Sparkles className="w-4 h-4" />
              </div>
              <span className="font-extrabold text-lg tracking-tight">
                {config.siteName.slice(0, 4)}
                <span className="text-[#7FFFD4]">{config.siteName.slice(4) || "Edit"}</span>
              </span>
            </div>
          ...
          <div className="flex items-center justify-between pb-8 mb-8 border-b border-[#071A2B]/10">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Curated articles maintained through the NextEdit console
              </p>
            </div>
